    ...
    <?php 
        ...
        */
        ...
        foreach ($numbers as $num ) {
            $sisaBagi = $num%5;   
            echo "<br>";
            echo "Array $num sisa baginya adalah:  $sisaBagi"; 
            echo "<br>";
            $rest[] = $sisaBagi;
        }
        echo "<br> Array Rest (Sisa Bagi) </br>";
        var_dump($rest);
        ...
        */
        ...
        // print_r($arrayAsosoatif);
        echo "<br>";
        foreach ($arrayAsosoatif as $key => $value) {
            echo "Array ( ['id'] => ".$value['id'].", ( ['name'] => ".$value['name'].", ( ['price'] => ".$value['price'].", ( ['description'] => ".$value['description'].", ( ['source'] => ".$value['source']." ) <br>";
        }
